...
void print_assembly()
{
    ...
    for(i=0; i<code_offset; i++)
    {
        ...
        switch(code[i].op)
        {
            ...
            case FOR_INI:
                            {
                                char for_start_label[]="FOR_START_LABEL_";
                                char number[10];
                                strcat(for_start_label,itoa(code[i].arg, number, 10));
                                printf("%s:\n", for_start_label);
                            }
                            printf("\n");
                            break;
            case FOR_START:
                            ...
                            printf("\tcmp eax, 0\n");
                            {
                                char for_end_label[]="FOR_END_LABEL_";
                                char number[10];
                                strcat(for_end_label,itoa(code[i].arg, number, 10));
                                printf("\tjle %s\n", for_end_label);
                            }
                            printf("\n");
                            break;
            case FOR_END:
                            {
                                char for_start_label[50]="FOR_START_LABEL_";
                                char for_end_label[50]="FOR_END_LABEL_";
                                char number[10];
                                itoa(code[i].arg, number, 10);
